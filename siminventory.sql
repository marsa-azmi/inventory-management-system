...
INSERT INTO `barang` (`id`, `nama_barang`, `stok`, `kode_barang`) VALUES
(1, 'Laptop', 10, 7586574),
(2, 'Printer', 5, 26568),
(3, 'kursi', 3, 12038490);
...
INSERT INTO `barang_keluar` (`id_keluar`, `id_barang`, `jumlah`, `tgl_keluar`, `keterangan`) VALUES
(1, 1, 10, '2025-07-10', 'Keluar untuk cabang A'),
(2, 2, 5, '2025-07-09', 'Dipinjam bagian IT'),
(3, 2, 2, '2025-07-08', 'Dipinjam bagian HR'),
(4, 0, 0, '0000-00-00', NULL);
...
INSERT INTO `barang_masuk` (`id`, `id_barang`, `jumlah`, `tanggal`) VALUES
(111, 1, 2, '0000-00-00'),
(1313, 1, 2, '2025-07-11');
